...
function omnicard_credits() {
	...
	echo '	<li><a href="https://ajdg.solutions/products/omnicard/?utm_source=omnicard_credits&utm_medium=omnicard-lite&utm_campaign=omnicard_link" target="_blank">'.__('OmniCard website', 'omnicard').'</a></li>';
	echo '	<li><a href="https://www.adrotateplugin.com/?utm_source=omnicard_credits&utm_medium=omnicard-lite&utm_campaign=adrotate_link" target="_blank">'.__('AdRotate for Wordpress website', 'omnicard').'</a></li>';
	...
	echo '	<li><a href="https://ajdg.solutions" title="AJdG Solutions"><img src="'.plugins_url().'/omnicard-lite/images/ajdg-logo-100x60.png" alt="ajdg-logo-100x60" width="100" height="60" align="left" style="padding: 0 10px 10px 0;" /></a>';
	echo '	<a href="https://ajdg.solutions" title="AJdG Solutions">AJdG Solutions</a> - '.__('Your one stop for Webdevelopment, consultancy and anything WordPress! When you need a custom plugin, theme customizations or have your site moved/migrated entirely. Find out more about what I can do for you on my website!', 'omnicard').' '.__('Visit the', 'omnicard').' <a href="https://ajdg.solutions/" target="_blank">AJdG Solutions</a> '.__('website', 'omnicard').'.</li>';
	echo '</ul></td>';
	echo '</tr>';
	echo '</tbody>';
...
function omnicard_notifications_dashboard() {
	...
	if($page == 'wc_gateway_omnicard') {
		...
		echo '			<a class="button" target="_blank" href="https://ajdg.solutions/products/omnicard/?utm_source=omnicard_banner&utm_medium=omnicard-lite&utm_campaign=upgrade_omnicard">'.__('Learn More', 'omnicard').'</a>';
		echo '		</div>';
