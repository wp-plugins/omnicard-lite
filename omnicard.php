 ...
 * Plugin URI: https://ajdg.solutions/?pk_campaign=omnicardlite-pluginpage&pk_kwd=pluginurl
 * Author: Arnan de Gans from AJdG Solutions
 * Author URI: http://meandmymac.net?pk_campaign=omnicardlite-pluginpage&pk_kwd=authorurl
...
function omnicard_credits() {
	...
	echo '	<li><a href="https://ajdg.solutions/products/omnicard/?pk_campaign=omnicardlite-credits&pk_kwd=omnicard_link" target="_blank">'.__('OmniCard website', 'omnicard').'</a></li>';
	echo '	<li><a href="https://ajdg.solutions/products/adrotate-for-wordpress/?pk_campaign=omnicardlite-credits&pk_kwd=adrotate_link" target="_blank">'.__('AdRotate for Wordpress website', 'omnicard').'</a></li>';
	echo '	<li><a href="http://meandmymac.net/?pk_campaign=omnicardlite-credits" target="_blank">'.__('My blog and website', 'omnicard').'</a></li>';
	echo '</ul></td>';
	echo '<td style="border-left:1px #ddd solid;" width="25%"><ul>';
	...
	echo '	<li><a href="https://ajdg.solutions/?pk_campaign=omnicardlite-credits&pk_kwd=ajdg_logo" title="AJdG Solutions"><img src="'.plugins_url().'/omnicard-lite/images/ajdg-logo-100x60.png" alt="ajdg-logo-100x60" width="100" height="60" align="left" style="padding: 0 10px 10px 0;" /></a>';
	echo '	<a href="https://ajdg.solutions/?pk_campaign=omnicardlite-credits&pk_kwd=ajdg_link" title="AJdG Solutions">AJdG Solutions</a> - '.__('Your one stop for Webdevelopment, consultancy and anything WordPress! When you need a custom plugin, theme customizations or have your site moved/migrated entirely. Find out more about what I can do for you on my website!', 'omnicard').' '.__('Visit the', 'omnicard').' <a href="https://ajdg.solutions/?pk_campaign=omnicardlite-credits&pk_kwd=ajdg_link" target="_blank">AJdG Solutions</a> '.__('website', 'omnicard').'.</li>';
	echo '</ul></td>';
	echo '</tr>';
	echo '</tbody>';
...
function omnicard_notifications_dashboard() {
	...
	if($page == 'wc_gateway_omnicard') {
		...
		echo '			<a class="button" target="_blank" href="https://ajdg.solutions/products/omnicard/?pk_campaign=omnicardlite-banner&pk_kwd=upgrade_omnicard">'.__('Learn More', 'omnicard').'</a>';
		echo '		</div>';
